  ...
  Promise.all([
    ...
    // --- 編成未表示化 --- //
      //if (firstStop.properties.hensei) {
        //imgHtml += `<img class="popup-img" src="${routePath}img/${firstStop.properties.hensei}" width="100"><br>`;
      //}

      if (firstStop.properties.stopStation) {
        imgHtml += `<img class="popup-img" src="${routePath}img/${firstStop.properties.stopStation}" width="100"><br>`;
      }

      imgs.forEach(file => {
        imgHtml += `<img class="popup-img" src="${routePath}img/${file}" width="100"><br>`;
      });
    ...
    stopStations.forEach(st => {
      ...
      if (index > 1 && isNearStation(lat, lng, sLat, sLng)) {
        ...
        //if (st.properties.hensei) {
          //imgHtml += `<img class="popup-img" src="${routePath}img/${st.properties.hensei}" width="100"><br>`;
        //}

        if (st.properties.stopStation) {
          imgHtml += `<img class="popup-img" src="${routePath}img/${st.properties.stopStation}" width="100"><br>`;
        }
